...
<html>
    ...
    <body>
        ...
        <div style="position: absolute;left: 35%;width: 32%; top: 31%;">
            ...
            <label class="radio-inline"><input type="radio" value="perfil"> Asesor</label>
        ...
        <div>
            ...
            <button style="background-color: darkcyan;color:cyan; position: absolute;left: 47.5%;top: 68.5%;height: 5.5%;">Registrarse</button>
        </div>
